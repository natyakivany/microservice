package com.natya.pelanggan.controller;
...
import com.natya.pelanggan.model.Pelanggan;
import com.natya.pelanggan.service.PelangganService;
...
public class PelangganController {
    ...
    @GetMapping
    public List<Pelanggan> getAllProduks(){
        return pelangganService.getAllPelanggan();
    }

    @GetMapping("/{id}")
    public ResponseEntity<Pelanggan> getPeodukById(@PathVariable long id) {
